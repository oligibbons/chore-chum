    ...
    return (
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="flex gap-2 overflow-x-auto pb-2">
          {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-8 w-24 rounded-full bg-gray-200 animate-pulse flex-shrink-0" />
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          ...
          <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
             {[1, 2, 3].map((col) => (
               <div key={col} className="space-y-4">
                  ...
                  {/* Cards */}
                  {[1, 2].map((card) => (
                      <div key={card} className="h-32 w-full rounded-xl border border-gray-200 bg-white p-4 space-y-3">
          ...
          {/* Sidebar Skeleton */}
          <div className="lg:col-span-1 h-64 rounded-2xl border border-gray-200 bg-white p-6 space-y-4">
